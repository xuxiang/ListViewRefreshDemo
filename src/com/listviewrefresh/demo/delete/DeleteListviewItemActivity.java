package com.listviewrefresh.demo.delete;
...
public class DeleteListviewItemActivity extends ListActivity {
	
	private ArrayAdapter<String> mAdapter;

	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_deleteitem_listview);
		...
		for (int i = 0; i < items.length; i++) {
			...
			dismissableButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					Toast.makeText(DeleteListviewItemActivity.this, "Clicked " + ((Button) view).getText(),
